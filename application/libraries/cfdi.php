...
class cfdi{
  ...
  public function obtenDatosCfdi33ComP($data)
  {
    ...
    $comPago = [
      'cadenaPago'        => "",
      'certificadoPago'   => "",
      'cuentaBen'         => $formaDePago != '01'? ($data['cuentaBen'] != ''? $data['cuentaBen']: ''): '',
      'cuentaOrd'         => $data['cuentaOrd'] != ''? $data['cuentaOrd'] : '',
      ...
      'nombreBancoOrdExt' => "",
      'numOperacion'      => "1",
      'rfcEmisorCtaBen'   => $formaDePago != '01'? ($data['rfcEmisorCtaBen'] != ''? $data['rfcEmisorCtaBen']: ''): '',
      'rfcEmisorCtaOrd'   => $data['rfcEmisorCtaOrd'] != ''? $data['rfcEmisorCtaOrd'] : '',
      'selloPago'         => "",
      'tipoCadPago'       => "",
      'tipoCambio'        => '1',
      'doctoRelacionado'  => []
